...
const google = window.google;
    ...
    export default function Maps(){
        ...
        const renderPolygons = (map) => {
            if (map && zoneData) {
                zoneData.forEach(zone => {
                    const key = zone.id;
                    const polygonPaths = zone.boundary_coordinates.coordinates.map(coordinate => {
        ...
        return <APIProvider apiKey="AIzaSyAHMyW1VBDgihMK85YB9Z4oayMxeZ2XEw8">
            <div  style={{ width: "100%", height: "418px" }}>
                <Map  defaultZoom={11} defaultCenter={default_position} mapId="3379961c48528892">
