    ...
    <>
      <nav className="flex justify-between items-center bg-blue-600 w-full pt-2.5 pr-4 pb-3 px-4 h-12 text-white">
        ...
        <Link to="insights" smooth={true} duration={500}>
          <Button className="text-base leading-normal" type="default">
            Learn More
          </Button>
        </Link>
      </nav>
        ...
        <div className="flex flex-col lg:flex-row gap-x-8 gap-y-16 justify-center items-center container mx-auto relative w-full">
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex space-x-4">
              <Button
                className="pr-4 text-base leading-normal"
                type="primary"
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-500 max-w-[732px] mx-auto text-xl leading-5	pb-16">
                ...
                effectiveness of your ad placements with actionable insights
                from Ad Optima.
              </p>
            </div>
                ...
                >
                  ...
                  >
                    <p className="pt-4 pr-6 pb-4 pl-4 text-gray-500 font-normal text-base leading-4	">
                      ...
                      subway ridership, Ad Optima can identify high-traffic
                  ...
                  >
                    <p className="pt-4 pr-6 pb-4 pl-4 text-gray-500 font-normal text-base leading-4	">
                      ...
                      segments more effectively, ensuring that your ads reach
                      the most relevant groups based on their age and gender
                      profiles.
                    </p>
                  </Panel>
                  <Panel
                  ...
                  >
                    <p className="pt-4 pr-6 pb-4 pl-4 text-gray-500 font-normal text-base leading-4	">
                      ...
                      Ad Optima ensures your ads reach the most relevant and
                      high-traffic areas.
                    </p>
                  </Panel>
                </Collapse>
          ...
          <div className="flex justify-center items-center">
            <div className="flex justify-between border border-gray-100 border-1 rounded-xl p-6 items-center bg-white container mx-auto">
              <div>
                ...
                <p className="text-neutral-500 leading-[18px]">
